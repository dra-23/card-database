...
<div class="sheet" id="cardSearchSheet">
  ...
  <div class="sheet-body">
    ...
    <div id="cs_status" style="display:none; font-size:16px; padding:6px 2px; color:var(--md-on-surface-variant);"></div>
...
<div class="sheet" id="psaSheet">
  ...
  <div class="sheet-body">
    ...
    <div style="display:flex; flex-direction:column; gap:14px;">
      ...
      <div id="psaFetchStatus" style="display:none; font-size:16px; padding:0 4px;"></div>
