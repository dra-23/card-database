...
function showDeleteConfirm(cardId) {
  ...
  overlay.innerHTML = `
    <div style="background:var(--md-surface);border-radius:28px;padding:24px;width:100%;max-width:320px;">
      ...
      <div style="font-size:17px;color:var(--md-on-surface-variant);margin-bottom:24px;line-height:1.5;">This card will be permanently deleted and cannot be undone.</div>
