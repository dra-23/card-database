    ...
    overlay.innerHTML = `
      <div style="background:var(--md-surface);border-radius:28px;padding:24px;width:100%;max-width:320px;">
        ...
        <div style="display:flex;gap:12px;">
          <button id="_priceSkip" style="flex:1;height:48px;border:none;border-radius:24px;background:var(--md-surface-2);font-family:'Google Sans',sans-serif;font-size:16px;font-weight:700;cursor:pointer;color:var(--md-on-surface);">Skip</button>
          <button id="_priceSave" style="flex:1;height:48px;border:none;border-radius:24px;background:#3D5AFE;color:#fff;font-family:'Google Sans',sans-serif;font-size:16px;font-weight:700;cursor:pointer;">Mark Sleevd</button>
        </div>
      </div>
    `
